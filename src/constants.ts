export const MSG = {
	...
	VERSION: 0x76657273,
	/** S→C palaceserver-go / ThePalace.app server build identity (`protocol_extensions.md`). */
	GO_SERVER_VER: 0x67766572,
	/** C→S machine id for Go servers (`win:` / `mac:` + platform UUID). FourCC `uuid`. */
	CLIENT_MACHINE_UUID: 0x75756964,
	WHISPER: 0x77686973,
	XTALK: 0x78746c6b,
	XWHISPER: 0x78776973,
	BLOWTHRU: 0x626c6f77,
...
/** LE `uint32` tag for MSG_BLOWTHRU “prop ready on media” (wire bytes `P`,`R`,`P`,`D`). See `protocol_extensions.md`. */
export const PROP_DONE_BLOWTHRU_TAG = 0x44505250;

export const spotConsts = {
